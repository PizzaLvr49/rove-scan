...
#define VL53L7CX_MAX_RESULTS_SIZE (40U + L5CX_AMB_SIZE + L5CX_SPAD_SIZE + L5CX_NTAR_SIZE + L5CX_SPS_SIZE + L5CX_SIGR_SIZE + L5CX_DIST_SIZE + L5CX_RFLEST_SIZE + L5CX_STA_SIZE + L5CX_MOT_SIZE + 20U)
...
#ifndef VL53L7CX_DISABLE_SIGNAL_PER_SPAD
	uint32_t signal_per_spad[(VL53L7CX_RESOLUTION_8X8 * VL53L7CX_NB_TARGET_PER_ZONE)];
#endif

	/* Sigma of the current distance in mm */
#ifndef VL53L7CX_DISABLE_RANGE_SIGMA_MM
	uint16_t range_sigma_mm[(VL53L7CX_RESOLUTION_8X8 * VL53L7CX_NB_TARGET_PER_ZONE)];
#endif

	/* Measured distance in mm */
#ifndef VL53L7CX_DISABLE_DISTANCE_MM
	int16_t distance_mm[(VL53L7CX_RESOLUTION_8X8 * VL53L7CX_NB_TARGET_PER_ZONE)];
#endif

	/* Estimated reflectance in percent */
#ifndef VL53L7CX_DISABLE_REFLECTANCE_PERCENT
	uint8_t reflectance[(VL53L7CX_RESOLUTION_8X8 * VL53L7CX_NB_TARGET_PER_ZONE)];
#endif

	/* Status indicating the measurement validity (5 & 9 means ranging OK)*/
#ifndef VL53L7CX_DISABLE_TARGET_STATUS
	uint8_t target_status[(VL53L7CX_RESOLUTION_8X8 * VL53L7CX_NB_TARGET_PER_ZONE)];
#endif
